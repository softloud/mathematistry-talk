...
\subsection{Heuristics of mathematistry}
...
h: C \times M \to \begin{cases}
                ...
                \varnothing & \text{if the heuristic does not apply to the pairing.}
            \end{cases}
  \]
  }
...
%%% Section cardinality
\subsection{A question of cardinality}
...
\section{Questions of Mathematistry}

\subsection{A question of density}
...
\subsection{The utility of heuristics}
...
\begin{frame}{\large{The steps in the building of an ecological model}}

QRP can happen at any stage of the model building process~\cite{gould_questionable_2019}:
